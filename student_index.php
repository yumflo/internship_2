...
if (isset($_POST['user_account'])) {
  ...
  $MM_redirectLoginFailed = "student_index_fail.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_localhost, $localhost);
  
  $LoginRS__query=sprintf("SELECT Account, Password FROM user_data WHERE Account=%s AND Password=%s",
  ...
  if ($loginFoundUser) {
    ...
    $_SESSION['MM_Student'] = $loginUsername;
