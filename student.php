...
/*我的目標*/
mysql_select_db($database_localhost, $localhost);
$query_courseshow = "SELECT * FROM course_data Where Account = '$id'";
//$query_limit_gbookshow = sprintf("%s LIMIT %d, %d", $query_gbookshow, $startRow_gbookshow, $maxRows_gbookshow);
$courseshow = mysql_query($query_courseshow, $localhost) or die(mysql_error());
$row_courseshow = mysql_fetch_assoc($courseshow);


///INSERT
$editcourseFormAction = $_SERVER['PHP_SELF'];
if (isset($_SERVER['QUERY_STRING'])) {
  $editcourseFormAction .= "?" . htmlentities($_SERVER['QUERY_STRING']);
}

if ((isset($_POST["CE_insert"])) && ($_POST["CE_insert"] == "courseform")) {
	
	$sql = "INSERT INTO course_data (Account, Text_a , Text_01 , Text_02 , Text_03 , Text_04 ,
	Text_05,Text_06,Text_07,Text_08,Text_09,Text_10,date) VALUES ('$id', '$_POST[textfield11]', '$_POST[textfield]', '$_POST[textfield10]', '$_POST[textfield9]','$_POST[textfield8]','$_POST[textfield7]' ,'$_POST[textfield6]','$_POST[textfield5]','$_POST[textfield4]','$_POST[textfield3]','$_POST[textfield2]',now())";
	
	$sql2 = "UPDATE course_data SET Text_a='$_POST[textfield11]' ,Text_01='$_POST[textfield]',Text_02='$_POST[textfield10]',Text_03='$_POST[textfield9]',Text_04='$_POST[textfield8]',Text_05='$_POST[textfield7]',Text_06='$_POST[textfield6]',Text_07='$_POST[textfield5]',Text_08='$_POST[textfield4]',Text_09='$_POST[textfield3]',Text_10='$_POST[textfield2]',date= now()
	WHERE Account='$id'";
	if($row_courseshow[date]==null){
	mysql_select_db($database_localhost, $localhost);
    $Result1  = mysql_query($sql, $localhost) or die(mysql_error());    
	}
	else {
	mysql_select_db($database_localhost, $localhost);
    $Result1  = mysql_query($sql2, $localhost) or die(mysql_error());                  
	}
...
/*秘訣*/
mysql_select_db($database_localhost, $localhost);
$query_tipshow = "SELECT * FROM tip_data Where Account = '$id'";
$tipshow = mysql_query($query_tipshow, $localhost) or die(mysql_error());
$row_tipshow = mysql_fetch_assoc($tipshow);

///INSERT
$editatipFormAction = $_SERVER['PHP_SELF'];
if (isset($_SERVER['QUERY_STRING'])) {
  $editatipFormAction .= "?" . htmlentities($_SERVER['QUERY_STRING']);
}

if ((isset($_POST["ATIP_insert"])) && ($_POST["ATIP_insert"] == "atipform")) {
	
	$sql = "INSERT INTO tip_data (Account, attention_tip,date) VALUES ('$id', '$_POST[textarea2]',now())";
	
	$sql2 = "UPDATE tip_data SET attention_tip='$_POST[textarea2]' ,date= now()
	WHERE Account='$id'";
	if($row_tipshow[date]==null){
	mysql_select_db($database_localhost, $localhost);
    $Result1  = mysql_query($sql, $localhost) or die(mysql_error());    
	}
	else {
...
///INSERT
$editrtipFormAction = $_SERVER['PHP_SELF'];
if (isset($_SERVER['QUERY_STRING'])) {
  $editrtipFormAction .= "?" . htmlentities($_SERVER['QUERY_STRING']);
}

if ((isset($_POST["RTIP_insert"])) && ($_POST["RTIP_insert"] == "rtipform")) {
	
	$sql = "INSERT INTO tip_data (Account, relax_tip,date) VALUES ('$id', '$_POST[textarea5]',now())";
	
	$sql2 = "UPDATE tip_data SET relax_tip='$_POST[textarea5]' ,date= now()
	WHERE Account='$id'";
	if($row_tipshow[date]==null){
	mysql_select_db($database_localhost, $localhost);
    $Result1  = mysql_query($sql, $localhost) or die(mysql_error());    
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="100%" height="30" align="right" valign="middle" bgcolor="#fbf074" ><table border="0" cellspacing="0" cellpadding="0">
      <tr>
<td align="center" valign="middle"><span class="brown"> <a class="menu"><font color="#FFFFF"><?
$result_name=mysql_query("SELECT Account FROM user_data Where account ='$id'");
while (list($n)=mysql_fetch_row($result_name)){$name  = $n;}echo $name;?>歡迎您</font></a>&nbsp;&nbsp;<a href="http://www.harvesteducation.cc/" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','photo/home2.png',1)"><img src="photo/home.png" name="Image13" height="12" border="0"></a>　<a href="<?php echo $logoutAction ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image12','','photo/logout2.png',1)"><img src="photo/logout.png" name="Image12" width="64" height="12" border="0"></a></span></td>        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<tr>
	    <td width="950"><table width="950" border="0" cellpadding="0" cellspacing="0">
	      ...
	      <tr>
	        <td height="15" align="right" valign="top" class="menu" ><a href="#" class="menu" id="toA">腦波教室</a>│<a href="#" class="menu"id="toB">我的目標</a>│<a href="#" class="menu" id="toC">專注力＆放鬆度</a>│<a href="#" class="menu"id="toF">綜合分析</a>│<a href="#" class="menu" id="toG">輔助音樂</a>│<a href="#" class="menu"id="toH">問問老師</a></span></span></span></td>
          </tr>
	      </table></td>
  </tr>
	  <tr>
...
<p><img src="photo/color.png" alt="" width="230"></td>
	  ...
	  <tr>
	    <td height="50" align="right" valign="middle"><a href="#" id="up6"><img src="photo/top-05.png" width="33" height="15" border="0"></a></td>
  </tr>
	  <tr><form id="courseform" name="courseform" method="POST" action="<?echo $editcourseFormAction;?>#B">
	    <td><table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        <td valign="top"><table width="35" border="0" align="right" cellpadding="0" cellspacing="0">
	          <tr>
	            <td width="26" align="center" valign="middle" bgcolor="#fbf074"><span class="menuwhite"><span class="boxtitle"><div id="B_class"></div></span><br>
	              我<br>
	              的<br>
	              目<br>
	              標<br>
...
<span class="chtitle"><span class="boxtitle">確定目標<br>
	          ...
	          <p>在完成這訓練程式後，我要達成的<br>
	            ...
	            <input name="textfield11" type="text" id="textfield2" size="160" value ="<?echo $row_courseshow[Text_a];?>">
	            <br>
              </p>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <p></p></td>
    ...
    <td align="right" valign="middle"><input name="textfield" type="text" id="textfield2" size="150" value ="<?echo $row_courseshow[Text_01];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>2.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield10" type="text" id="textfield3" size="150" value ="<?echo $row_courseshow[Text_02];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>3.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield9" type="text" id="textfield4" size="150" value ="<?echo $row_courseshow[Text_03];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>4.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield8" type="text" id="textfield5" size="150" value ="<?echo $row_courseshow[Text_04];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>5.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield7" type="text" id="textfield6" size="150" value ="<?echo $row_courseshow[Text_05];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>6.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield6" type="text" id="textfield7" size="150" value ="<?echo $row_courseshow[Text_06];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>7.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield5" type="text" id="textfield8" size="150" value ="<?echo $row_courseshow[Text_07];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>8.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield4" type="text" id="textfield9" size="150" value ="<?echo $row_courseshow[Text_08];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>9.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield3" type="text" id="textfield10" size="150" value ="<?echo $row_courseshow[Text_09];?>"></td>
  </tr>
  <tr>
    <td align="right" valign="middle"><p>10.
      ...
      <p></p></td>
    <td align="right" valign="middle">&nbsp;</td>
    <td align="right" valign="middle"><input name="textfield2" type="text" id="textfield" size="150" value ="<?echo $row_courseshow[Text_10];?>"></td>
  </tr>
  <tr valign="top">
	...
	<input type="hidden" name="CE_insert" value="courseform" />
</table></div></td>
          </tr>
        </table></td>
		</form>
	  ...
	  <tr>
	    <td height="50" align="right" valign="middle"><p><a href="#" id="up5"><img src="photo/top-05.png" alt="" width="33" height="15" border="0"></a></p></td>
  </tr>
	  <tr>
	    <td><table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td valign="top" width="915"><div class="info1" style="border-style:solid; border-width:2px 2px 2px 2px; border-color:#fbf074 #fbf074 #fbf074 #fbf074;padding:20px 20px 20px 20px; background-color:#FFF" >
	          <table width="600"  border="0" align="center" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	              <form name="atipform" method="post" action="<? echo $editatipFormAction;?>#C"><td align="center">
	            ...
	            <tr>
	              <td align="center"><textarea name="textarea2" id="textarea2" cols="102" rows="3"><?echo $row_tipshow[attention_tip];?></textarea></td>
                </tr>
	            <tr>
	              <td align="right"><input type="Submit" name="Send3" id="Send3" value="送出"></td>
				  <input type="hidden" name="ATIP_insert" value="atipform" />
                </tr>
				</form>
	            <tr>
	            ...
	            <tr>
	              <form name="rtipform" method="post" action="<?echo $editrtipFormAction;?>#C"><td align="center">
	            ...
	            <tr>
	              <td align="center"><textarea name="textarea5" id="textarea5" cols="102" rows="3"><?echo $row_tipshow[relax_tip];?></textarea></td>
                </tr>
	            <tr>
	              <td align="right"><input type="Submit" name="Send6" id="Send6" value="送出"></td>
				  <input type="hidden" name="RTIP_insert" value="rtipform" />
                </tr>
				</form>
	            <tr>
...
<form id="form1" name="form1" method="post" onsubmit="return Check_submit();" action="student.php#part_one">
...
<input name="submit" type="submit" value="送出" />
  ...
  <form method="post" action="student.php#part_one"> 
...
echo(chart_str(1000, 300, 'part_one_line_data.php?type='));	
}
...
$_SESSION['part_one2'] = $get_num2;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_one_line_data_other.php?type='));	
}
function paint3($get_num,$get_num2,$get_date){
session_start();
$_SESSION['part_one'] = $get_num;
$_SESSION['part_one2'] = $get_num2;
$_SESSION['OrderDate'] = $get_date;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_one_line_data_total.php?type='));	
}
?>
</form>
<?
...
echo $attdata_part_one;
	...
	for($j_atotal_part_one = 0 ; $j_atotal_part_one<=($output_count_atotal_part_one-1) ; $j_atotal_part_one++){
		if($atoutput_part_one[$j_atotal_part_one]<40)
		{
			$following ++ ;
	...
	$last_asum_part_one +=$asum_part_one;
	$last_acount_part_one+=$acount_part_one;
	$attdata_part_one = round (100-(($following / $last_acount_part_one)*100),2);
...
echo $mttdata_part_one;
	...
	for($j_mtotal_part_one = 0 ; $j_mtotal_part_one<=($output_count_mtotal_part_one-1) ; $j_mtotal_part_one++){
		$msum_part_one += $mtoutput_part_one[$j_mtotal_part_one];
		if($mtoutput_part_one[$j_mtotal_part_one]<40)
		{
			$following++;
	...
	$mttdata_part_one = round (100-(($following / $last_mcount_part_one)*100),2);
...
<form id="form1" name="form1" method="post" onsubmit="return Check_submit();" action="student.php#part_two">
...
<form method="post" action="student.php#part_two"> 
	<input type = "date" name = "OrderDate_two"  id = "OrderDate_two" value = "" /> 
	<input id = "Submit" type = "submit" value = "送出" /> 
  </form>
...
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_two_line_data.php?type='));	
}
...
$_SESSION['part_two2'] = $get_num_two2;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_two_line_data_other.php?type='));	
}
function paint_two3($get_num_two,$get_num_two2,$get_date_two){
session_start();
$_SESSION['part_two'] = $get_num_two;
$_SESSION['part_two2'] = $get_num_two2;
$_SESSION['OrderDate_two'] = $get_date_two;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_two_line_data_total.php?type='));	
}
?>
</form>
<?
if( $_POST['CheckboxGroup_two'] == null ){
	$num_two = null;
	$num_two2 = null; 
	$date_two = $OrderDate_two;
	echo paint_two3($num_two,$num_two2,$date_two);	
}
else{
...
echo $attdata_part_two;
	...
	for($j_atotal_part_two = 0 ; $j_atotal_part_two<=($output_count_atotal_part_two-1) ; $j_atotal_part_two++){
		if($atoutput_part_two[$j_atotal_part_two]<40)
		{
		$following++;
	...
	$last_asum_part_two +=$asum_part_two;
	$last_acount_part_two+=$acount_part_two;
	$attdata_part_two = round (100-(($following / $last_acount_part_two)*100),2);
...
echo $mttdata_part_two;
	...
	for($j_mtotal_part_two = 0 ; $j_mtotal_part_two<=($output_count_mtotal_part_two-1) ; $j_mtotal_part_two++){
		if( $mtoutput_part_two[$j_mtotal_part_two]<40)
		{
		$following++;
	...
	$mttdata_part_two = round (100-(($following / $last_mcount_part_two)*100),2);
...
?>  
	            ...
	            <tr>
	              <td align="center"><a name="part_three"></a>
<form id="form1" name="form1" method="post" onsubmit="return Check_submit();" action="student.php#part_three">
        <input type="checkbox" id="ck13" name="CheckboxGroup_three[]" value="13" class="field checkbox" onchange="handleInput(this);"/>
       <label  class="choice" for="ck13"> Stage 13</label>

        <input type="checkbox" id="ck14" name="CheckboxGroup_three[]" value="14" class="field checkbox" onchange="handleInput(this);"/>
       <label  class="choice" for="ck14"> Stage 14</label>

        <input type="checkbox" id="ck15" name="CheckboxGroup_three[]" value="15" class="field checkbox" onchange="handleInput(this);"/>
        <label  class="choice" for="ck15">Stage 15</label>

        <input type="checkbox" id="ck16" name="CheckboxGroup_three[]" value="16" class="field checkbox" onchange="handleInput(this);"/>
        <label  class="choice" for="ck16">Stage 16</label>

        <input type="checkbox" id="ck17" name="CheckboxGroup_three[]" value="17" class="field checkbox" onchange="handleInput(this);"/>
       <label  class="choice" for="ck17"> Stage 17</label>

        <input type="checkbox" id="ck18" name="CheckboxGroup_three[]" value="18" class="field checkbox" onchange="handleInput(this);"/>
        <label  class="choice" for="ck18">Stage 18</label>
<input name="submit" type="submit" value="送出" />
        
</form>

	<form method="post" action="student.php#part_three"> 
	<input type = "date" name = "OrderDate_three"  id = "OrderDate_three" value = "" /> 
	<input id = "Submit" type = "submit" value = "送出" /> 
	</form>
...
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_three_line_data.php?type='));	
}
...
$_SESSION['part_three2'] = $get_num_three2;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_three_line_data_other.php?type='));	
}
function paint_three3($get_num_three,$get_num_three2,$get_date_three){
session_start();
$_SESSION['part_three'] = $get_num_three;
$_SESSION['part_three2'] = $get_num_three2;
$_SESSION['OrderDate_three'] = $get_date_three;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(1000, 300, 'part_three_line_data_total.php?type='));	
}
?>
</form>
<?
if( $_POST['CheckboxGroup_three'] == null ){
	$num_three = null;
	$num_three2 = null; 
	$date_three = $OrderDate_three;
	echo paint_three3($num_three,$num_three2,$date_three);	
}
else{
...
require("Connections/conndb.php");
/*---------------------------------------------------------------------------------------------------------------------*/	
		$result_time_part_three=mysql_query("SELECT Max(LongATN) , Max(LongMTN) FROM part_three Where account ='$id'");
...
echo $attdata_part_three;
	...
	for($j_atotal_part_three = 0 ; $j_atotal_part_three<=($output_count_atotal_part_three-1) ; $j_atotal_part_three++){
		if($atoutput_part_three[$j_atotal_part_three]<40)
		{
			$following++;
	...
	$last_asum_part_three +=$asum_part_three;
	$last_acount_part_three+=$acount_part_three;
	$attdata_part_three = round (100-(($following / $last_acount_part_three)*100),2);
...
echo $mttdata_part_three;
	...
	for($j_mtotal_part_three = 0 ; $j_mtotal_part_three<=($output_count_mtotal_part_three-1) ; $j_mtotal_part_three++){
		if($mtoutput_part_three[$j_mtotal_part_three]<40)
		{
			$following++;
	...
	$mttdata_part_three = round (100-(($following / $last_mcount_part_three)*100),2);
...
?>
	                <tr>
	                  ...
	                  <td width="20" align="center">&nbsp;</td>
	                  <td width="80" align="left">平均專心值</td>
	                  <td><? echo $attdata_part_three; ?></td>
	                  <td width="20" align="center" valign="middle">│</td>
	                  <td width="80">平均放鬆值</td>
	                  <td><? echo $mttdata_part_three; ?></td>
	                  <td width="20" align="center">│</td>
	                  <td width="90">最長專注時間</td>
	                  <td><? echo $attime_part_three; ?></td>
	                  <td width="20" align="center">│</td>
	                  <td width="90" height="30">最長放鬆時間</td>
	                  <td><? echo $mttime_part_three; ?></td>
	                  </tr>
	                </table></td>
                </tr>
	            <tr>
	            ...
	            <tr>
	              <td align="center"><a name="part_four"></a>
                  <form id="form1" name="form1" method="post" onsubmit="return Check_submit();" action="student.php#part_four">
	                <input type="checkbox" id="ck19" name="CheckboxGroup_four[]" value="19" class="field checkbox" onchange="handleInput(this);"/>
       <label  class="choice" for="ck19"> Stage 19</label>

        <input type="checkbox" id="ck20" name="CheckboxGroup_four[]" value="20" class="field checkbox" onchange="handleInput(this);"/>
       <label  class="choice" for="ck20"> Stage 20</label>

        <input type="checkbox" id="ck21" name="CheckboxGroup_four[]" value="21" class="field checkbox" onchange="handleInput(this);"/>
        <label  class="choice" for="ck21">Stage 21</label>
...
<input name="submit" type="submit" value="送出" />
	...
	<form method="post" action="student.php#part_four"> 
	<input type = "date" name = "OrderDate_four"  id = "OrderDate_four" value = "" /> 
	<input id = "Submit" type = "submit" value = "送出" /> 
	</form>
...
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(950, 300, 'part_four_line_data.php?type='));	
}
...
$_SESSION['part_four2'] = $get_num_four2;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(950, 300, 'part_four_line_data_other.php?type='));	
}
function paint_four3($get_num_four,$get_num_four2,$get_date_four){
session_start();
$_SESSION['part_four'] = $get_num_four;
$_SESSION['part_four2'] = $get_num_four2;
$_SESSION['OrderDate_four'] = $get_date_four;
include_once('php-ofc-library/line_for_chart.php');
echo(chart_str(950, 300, 'part_four_line_data_total.php?type='));	
}
?>
</form>
<?
if($_POST['CheckboxGroup_four'] == null ){
	$num_four = null;
	$num_four2 = null; 
	$date_four = $OrderDate_four;
	echo paint_four3($num_four,$num_four2,$date_four);	
}
else{
...
require("Connections/conndb.php");
/*---------------------------------------------------------------------------------------------------------------------*/	
		$result_time_part_four=mysql_query("SELECT Max(LongATN) , Max(LongMTN) FROM part_four Where account ='$id'");
...
echo $attdata_part_four;
	...
	for($j_atotal_part_four = 0 ; $j_atotal_part_four<=($output_count_atotal_part_four-1) ; $j_atotal_part_four++){
		if($atoutput_part_four[$j_atotal_part_four]<40)
		{
			$following++;
	...
	$last_asum_part_four +=$asum_part_four;
	$last_acount_part_four+=$acount_part_four;
	$attdata_part_four = round (100-(($following / $last_acount_part_four)*100),2);
...
echo $mttdata_part_four;
	...
	for($j_mtotal_part_four = 0 ; $j_mtotal_part_four<=($output_count_mtotal_part_four-1) ; $j_mtotal_part_four++){
		if($mtoutput_part_four[$j_mtotal_part_four]<40)
		{
			$following++;
	...
	$mttdata_part_four = round (100-(($following / $last_mcount_part_four)*100),2);
...
?>
	                <tr>
	                  ...
	                  <td width="20" align="center">&nbsp;</td>
	                  <td width="80" align="left">平均專心值</td>
	                  <td><? echo $attdata_part_four; ?></td>
	                  <td width="20" align="center" valign="middle">│</td>
	                  <td width="80">平均放鬆值</td>
	                  <td><? echo $mttdata_part_four; ?></td>
	                  <td width="20" align="center">│</td>
	                  <td width="90">最長專注時間</td>
	                  <td><? echo $attime_part_four; ?></td>
	                  <td width="20" align="center">│</td>
	                  <td width="90" height="30">最長放鬆時間</td>
	                  <td><? echo $mttime_part_four; ?></td>
	                  </tr>
	                </table></td>
                </tr>
              </table>
	  ...
	  <tr>
	    <td height="50" align="right" valign="middle"><a href="#" id="up4"><img src="photo/top-05.png" alt="" width="33" height="15" border="0"></a></td>
  </tr>
	  <tr>
	    <td><table border="0" cellspacing="0" cellpadding="0">
	      <tr>
		...
		if($attdata_pie>$mttdata_pie){
			...
			print($output);
	            ...
	            <tr>
                 ...
                 <tr>
	              <td width="100%">每天大約用十五至三十分鐘，給自己一個機會，訓練自己成為放鬆的大師。</td>
                </tr>
	            <tr>
...
<?php } // Show if recordset not empty ?>
	  ...
	  <tr>
	    <td height="50" align="right" valign="middle"><a href="#" id="up3"><img src="photo/top-05.png" alt="" width="33" height="15" border="0"></a></td>
  </tr>
	  <tr>
	    <td><table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	...
	適合各種狀況的音樂下載（需額外付費）
	  ...
	  <tr>
	    <td height="50" align="right" valign="middle"><a href="#" id ="up2"><img src="photo/top-05.png" alt="" width="33" height="15" border="0"></a></td>
  </tr>
	  <tr>
	    <td><table border="0" cellspacing="0" cellpadding="0">
	      <tr>
	        ...
	        <td valign="top" width="915"><div class="info1" style="border-style:solid; border-width:2px 2px 2px 2px; border-color:#fbf074 #fbf074 #fbf074 #fbf074;padding:20px 20px 20px 20px; background-color:#FFF" >
	          <form id="qaform" name="qaform" method="POST" action="<?php echo $editFormAction; ?>#qa" >
	            <table width="850" border="0" cellpadding="0" cellspacing="0">
	              <tr>
	                <td valign="top">我的名字：</td>
	                <td valign="top"><label for="name">
	                  <?
$result_name=mysql_query("SELECT Account FROM user_data Where account ='$id'");
while (list($n)=mysql_fetch_row($result_name)){
$name  = $n;
		}
echo $name;
					?>
	                ...
	                <td width="30"></td>
	                <td valign="top">我的問題：</td>
	                <td width="80" rowspan="3" valign="top"><span id="sprytextfield1">
	                  <label for="q"></label>
	                  <span class="textfieldRequiredMsg"></span></span>
                      <textarea name="gcomment" id="gcomment" cols="75" rows="10"></textarea>
...
?>
        ...
        <?php
} while ($row_user_data = mysql_fetch_assoc($user_data));
  $rows = mysql_num_rows($user_data);
  if($rows > 0) {
      mysql_data_seek($user_data, 0);
	  $row_user_data = mysql_fetch_assoc($user_data);
  }
?>
      </select>
                  ...
                  <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td align="right"><input class="classname" type="Submit" name="Send" id="Send" value="送出"></td>
                  </tr>
                  <tr> </tr>
                  <tr> </tr>
                </table>
                <input type="hidden" name="MM_insert" value="qaform" />
	          </form>
	        </div></td>
          </tr>
        </table></td>
	  ...
	  <tr>
	    <td height="80" align="right" valign="top" class="more"><br>
        <a href="#" id="up"><img src="photo/top-05.png" alt="" width="33" height="15" border="0"></a></td>
  </tr>
</table>
<table width="950" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
