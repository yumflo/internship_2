...
$num5 = 0;
	/*抓取日期資料筆數*/
	$date_data_total = mysql_query("SELECT distinct (date) FROM total_data WHERE (stage = 2 or stage = 3 or stage = 5 or stage = 6 or stage = 8 or stage = 9 or stage = 11 or stage = 12) and account ='$id'");
	/*日期有幾筆*/
...
/*For迴圈 Run日期筆數*/
	...
	$result=mysql_query("SELECT attention FROM total_data WHERE (stage = 2 or stage = 3 or stage = 5 or stage = 6 or stage = 8 or stage = 9 or stage = 11 or stage = 12) and date = '$day_atotal_atotal' and account = '$id'");
